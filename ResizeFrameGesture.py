...
class ResizeFrameGesture:
    def __init__(self, default_value=((300, 100), (600, 500)), invert_controls=False):
    ...
    def detect_move_gesture(self, lm_list_left, lm_list_right, upper_bound=20):
    ...
    def execute(self, capture, hand_left, hand_right, hand_left_num, hand_right_num, hand_count, scale=0.2, min_size_incr=1, min_move_incr=1, threshold=True):
        dist_diff = 0
        lm_list_left = hand_left.lm_list
        lm_list_right = hand_right.lm_list
    ...
    def move_frame_control(self, img, incr, frame_incr=1):
